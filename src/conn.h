...
typedef struct conn_mode_entry {
	...
	int (*incoming_func)(juice_agent_t *agent, const addr_record_t *src, const char *data,
	                  size_t size);
...
int conn_extern_incoming(juice_agent_t *agent, const addr_record_t *src, const char *data,
                         size_t size);
